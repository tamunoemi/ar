...
/*  Set the URL to your Sendy installation (without the trailing slash) */
	...
	//define('APPPATH', 'http://localhost/Sendy_igniter');
...
else if(stristr($host, "localhost") !== FALSE || stristr($host, '127.0.0.1') !== FALSE){
   $config['base_url'] = $protocol.$host."/sendy_igniter/";
}
else{
