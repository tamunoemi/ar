...
<?php	
	if(get_app_info('is_sub_user')) 
	{
		...
		{
			echo '<script type="text/javascript">window.location="'.addslashes(get_app_info('path')).'/index.php/site/blacklist-blocked-domains?i='.get_app_info('restricted_to_app').'"</script>';
			exit;
		}
	    	...
	    	<div class="span12">
		    	...
		    	<div class="well">
			    	<div class="btn-group" data-toggle="buttons-radio">
					  <a href="<?php echo get_app_info('path');?>/index.php/site/blacklist-suppression?i=<?php echo get_app_info('app');?>" title="" class="btn"><i class="icon icon-remove-circle"></i> <?php echo _('Suppression list');?></a>
			...
			<div class="span12">
	    		...
	    		<div style="float:left; width: 100%; margin-bottom: 20px;">
				    ...
				    <div style="float:right;">
					    <form class="form-search" action="<?php echo get_app_info('path');?>/index.php/site/blacklist-blocked-domains" method="GET" style="float:right;">
		...
		<div class="row-fluid well" style="float:left; margin:-20px 0 40px 0; <?php if(isset($_GET['e'])) echo 'display:block;';?>" id="import-blocked-domain-list-csv">
			<div class="span6">
				<div>
				    ...
				    <form action="<?php echo get_app_info('path')?>/index.php/site/subscribers/import-blocked-domain-list" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="import-update-form">
			    ...
			    <div>
				    ...
				    <form action="<?php echo get_app_info('path')?>/index.php/site/subscribers/import-blocked-domain-list2" method="POST" accept-charset="utf-8" class="form-vertical" enctype="multipart/form-data" id="import-update-form2">
						  	    ...
						  	    while($row = mysqli_fetch_array($r))
						  	    {
								      ...
								      <script type="text/javascript">
								        $("#delete-btn-'.$id.'").click(function(e){
											...
											if(c)
											{
												$.post("includes/subscribers/delete-blocked-domain", { app: '.get_app_info('app').', domain_id: '.$id.' },
												  function(data) {
												      if(data)
												      {
												      	$("#'.$id.'").fadeOut();
