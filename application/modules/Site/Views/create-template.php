...
<div class="row-fluid">
    ...
    <div class="span10">
	    ...
	    <div class="row-fluid">
	    	...
	    	<form action="<?php echo get_app_info('path')?>/index.php/site/templates/save-template?i=<?php echo get_app_info('app')?>" method="POST" accept-charset="utf-8" class="form-vertical" id="edit-form">
