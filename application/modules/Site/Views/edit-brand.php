		        ...
		        <div id="collapse0" class="accordion-body collapse">
			    	...
			    	<div class="control-group">
				    	<div class="controls">
							...
							<!-- Custom domain -->
			                <input type="text" class="input-xlarge" id="custom_domain" name="custom_domain" placeholder="<?php echo 'Eg. domain.com or sub.domain.com'?>" value="<?php echo get_saved_data('custom_domain');?>" <?php echo $licensed_custom_domain_maxed && get_saved_data('custom_domain')=='' ? 'disabled' : ''; ?>>
		    		...
		    		<div id="collapse2_1" class="accordion-body collapse in">
				    	<p><strong><?php echo _('Login URL');?></strong>: 
					    	...
					    	<?php
								...
								$domain = $parse['host'];
								$path = $parse['path']; 
						    	if(get_saved_data('custom_domain')=='')
					    ...
					    <p><strong><?php echo _('Login email');?></strong>: <input type="text" name="login_email" id="login_email" placeholder="<?php echo _('name@domain.com');?>" value="<?php echo get_login_data('username');?>" style="margin-top: 5px;"/></p>
