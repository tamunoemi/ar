...
<form action="<?php echo get_app_info('path')?>/index.php/site/list/edit" method="POST" accept-charset="utf-8" class="form-vertical">
    ...
    <div class="span10">
	    ...
	    <div class="row-fluid">
		    ...
		    <div class="span12">
				...
				<div class="checkbox">
				  <label><input type="checkbox" name="notify_new_signups" id="notify_new_signups" <?php echo get_lists_data('notify_new_signups', $lid)==1 ? 'checked' : '';?>><?php echo _('Send email notification on new signups?');?></label>
				</div>
