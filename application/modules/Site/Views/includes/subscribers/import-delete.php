...
if(!file_exists($csvfile)) {
	header("Location: ".get_app_info('path').'/index.php/site/delete-from-list?i='.$app.'&l='.$listID.'&e=3'); 
	exit;
}
...
foreach(explode($lineseparator,$csvcontent) as $line)
{
	...
	if($columns>1)
	{
		header("Location: ".get_app_info('path').'/index.php/site/delete-from-list?i='.$app.'&l='.$listID.'&e=1'); 
		exit;
	}
