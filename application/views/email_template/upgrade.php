            ...
            <table class="w320" cellspacing="0" cellpadding="0" width="500">
              <tr>
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <tr>
                    <td style="padding-bottom:20px;">
                        Dear <b> <?= $fname; ?>, </b><br>
                      <br>
                          This is to notify you that we just upgraded your account to <b><?= $plan; ?></b> <br>
                      <br>
                      <b><a class="blue-link" href="https://app.ecomcache.com">Product Access Information:</a></b>
                    </td>
                  </tr>
                </table>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                  <tr>
                    <td class="left" style="padding-bottom:20px; text-align:left;">
                     <b>Name:</b> <?= $name; ?><br>
                      ...
                      <b>Your Password:</b> You current account password
                  ...
                  <tr>
                      <td><b>Login Page: https://app.ecomcache.com </b></td>
                  </tr>
