...
if($pass=='' || $email=='')
{
	...
	if($redirect_to=='') header("Location: http://localhost/sendy_igniter/index.php/auth"."/login?e=1");
...
else
{
	...
	if ($r && mysqli_num_rows($r) > 0)
	{
		...
		{			
			...
			{
				if($redirect_to=='') {
					//This is where I need to set the page to after successful login
					//var_dump(get_app_info('path')); exit();
