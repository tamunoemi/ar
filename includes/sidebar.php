...
<div class="sidebar-nav sidebar-box">
	...
	<?php if(get_app_info('campaigns_only')==0):?>
	    <ul class="nav nav-list">
	        ...
	        <li <?php if(currentPage()=='app'){echo 'class="active"';}?>><a href="<?php echo get_app_info('path').'/index.php/site/app?i='.$app;?>"><i class="icon-home <?php if(currentPage()=='app'){echo 'icon-white';}?>"></i> <?php echo _('All campaigns');?></a></li>
	        <li <?php if(currentPage()=='create' || currentPage()=='send-to' || currentPage()=='edit'){echo 'class="active"';}?>><a href="<?php echo get_app_info('path').'/index.php/site/create?i='.$app;?>"><i class="icon-edit  <?php if(currentPage()=='create' || currentPage()=='send-to.php' || currentPage()=='edit.php'){echo 'icon-white';}?>"></i> <?php echo _('New campaign');?></a></li>
	    </ul>	
	<?php endif;?>
	...
	<?php if(get_app_info('templates_only')==0):?>
	    <ul class="nav nav-list">
	        ...
	        <li <?php if(currentPage()=='templates' || currentPage()=='edit-template' || currentPage()=='create-template'){echo 'class="active"';}?>><a href="<?php echo get_app_info('path').'/index.php/site/templates?i='.$app;?>"><i class="icon-envelope <?php if(currentPage()=='templates.php' || currentPage()=='edit-template.php' || currentPage()=='create-template.php'){echo 'icon-white';}?>"></i> <?php echo _('All templates');?></a></li>
	    </ul>
	<?php endif;?>
