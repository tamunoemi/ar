...
(1, 1, 'Kiire', 'Robert Emi', 'info@robertemi.com', 'info@robertemi.com', 'USD', '', '', 'smtp.mailgun.org', '587', 'ssl', 'postmaster@app.xtargeter.net', '2de0a4e1e5f7c51ef185dab55baa0418-2bf328a5-6d34ad29', 0, 0, 'Ti6qHhWnQuokdQ2I7uxeqaz1TrZ2hQ', -1, 0, 1, '', NULL, 0, NULL, '1.png', 'jpeg,jpg,gif,png,pdf,zip', 0, 0, 0, 0, 1, 10, '', 0, 1, 0, '', '', '', 'http', 0, '', 'date'),
